...
## Slide 6: API Security Tips – حماية الـ APIs

- ✅ تأكد من التحقق من صحة المدخلات (Input Validation)
- ✅ استخدم `prepared statements` لتجنب SQL Injection
- ✅ تعقيم البيانات المعروضة (Output Sanitization) ضد XSS
- ✅ حماية الجلسات وملفات الكوكيز
- ✅ سجل محاولات الوصول الفاشلة
- ✅ **استخدم التوكنات (Token-Based Auth)**:
...
- يمكن استخدام `Bearer Token` في الـ headers للطلبات.
- للتطبيقات الأكبر، استخدم JWT أو OAuth2.
